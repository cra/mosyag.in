...
BLOG_AUTHOR = "Igor Mosyagin"  # (translatable)
BLOG_TITLE = "How to change this title?"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://mosyag.in/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://mosyag.in/"
BLOG_EMAIL = "c6h10o5@gmail.com"
BLOG_DESCRIPTION = "Irregular mind dumps and other notes"  # (translatable)
